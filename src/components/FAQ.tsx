...
const items = [
  ...
  { icon: "fa-file-image", q: "Quels formats de fichiers sont inclus ?", a: "Tous les motifs sont fournis en haute résolution (300 DPI minimum), compatibles avec les formats d'impression standards : A3, A4, A5, 50x70cm et plus..." },
